...
export function CartHandle() {
  ...
  return (
    <>
      ...
      <div className="w-[500px] max-md:w-[300px] z-40 bg-white border text-black shadow-2xl rounded-xl px-6 py-3 fixed bottom-2 right-20 flex flex-row gap-2 items-center justify-between">
