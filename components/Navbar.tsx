...
export function Navbar() {
  ...
  return (
    <nav className="fixed md:left-20 md:right-20 left-2 right-2 md:top-4 top-2 mx-auto z-40 md:shadow-sm rounded-xl bg-white border border-gray-300 max-w-full">
