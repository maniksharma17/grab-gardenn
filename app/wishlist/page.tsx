      ...
      <div className="mt-16 container mx-auto">
        ...
        {wishlistProducts.length === 0 ? (
          ...
          <div className="container mx-auto px-4 md:px-8 py-6 pt-2 max-md:py-2">
            <h2 className="text-4xl my-6 max-md:text-2xl px-4 font-medium text-primary text-left">Your Wishlist</h2>
            {/** Products grid */}
<div
  className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-x-2 gap-y-6 md:gap-x-4 md:gap-y-12"
>
