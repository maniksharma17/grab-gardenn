...
import { Leaf, Heart, Globe, HandHeart, CircleCheck } from "lucide-react";
...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="bg-green-700 relative h-[250px] mt-12 w-full mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto">
            ...
            <div className="md:w-1/2 bg-card rounded-2xl border shadow-md p-6 md:p-10 flex flex-col items-start gap-6">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-700 leading-relaxed max-w-prose">
                  ...
                  Dehradun. Throughout her career, she has seamlessly blended
                  her academic expertise with practical business experience,
                  positioning herself as an influential figure in the realms of
                  education and community service.
                  <br />
                  <br />
                  Dr. Saini is particularly passionate about empowering women
                  and fostering inclusive development through strategic
                  initiatives. Her experience spans various sectors, equipping
                  her with a versatile skill set that encompasses both
                  theoretical and practical knowledge.
                  <br />
                  <br />
                  Her core competencies include strategic planning, keen
                  observation, and a commitment to learning and development.
                  These attributes not only enhance her effectiveness as a
                  leader but also enable her to uplift her team members. As a
                  ...
                  involvement in programs aimed at uplifting future generations
                  of leaders. She firmly believes that empowering females is
                  essential for societal progress and economic development.
                </p>
              </div>
            </div>
            ...
            <div className="md:w-1/2 bg-card rounded-2xl border shadow-md p-6 md:p-10 flex flex-col items-start gap-6">
              ...
              <div className="text-left">
                ...
                <p className="text-muted-foreground mb-4">Co-Founder</p>
                <p className="text-sm text-gray-700 leading-relaxed max-w-prose">
                  Dr. Preeti Rana, a doctorate in Management from Doon
                  University, brings over a decade of experience in research and
                  academia, specializing in Sustainable Supply Chain Management
                  with a focus on SMEs in Uttarakhand. She has led impactful
                  research projects funded by JICA and ICSSR and presented her
                  work at prestigious platforms like IIM Kashipur and the
                  University of State Fiscal Service of Ukraine, with
                  publications in ABDC, Web of Science, and Scopus-indexed
                  journals.
                  <br />
                  <br />
                  After a successful academic career as an Assistant Professor
                  and Research Head, she now takes a plunge into
                  entrepreneurship with Grab Gardenn, aiming to empower women
                  and local farmers by promoting Himalayan products.
                  <br />
                  <br />
                  Dr. Rana is deeply dedicated to the empowerment of women and
                  the upliftment of local farmers in the Uttarakhand Himalayas.
                  She actively works towards creating opportunities for women to
                  achieve financial independence and encourages sustainable
                  agricultural practices that enhance the livelihoods of
                  farmers.
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  With a strong sense of purpose, Dr. Rana leads Grab Gardenn
                  not just as a business, but as a platform for empowerment and
                  community well-being. Her unwavering dedication to growing
                  together with the local community reflects her belief that
                  every milestone she achieves should also uplift those around
                  her.
                </p>
              </div>
            </div>
      ...
      {/* Join Our Journey */}
      <div className="text-center max-md:py-10 py-8 px-4">
