...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://script.google.com/macros/s/AKfycbyKdH59qcVykq4qBADG8RTzOeBcbFI7YO1oVKaAI8rUCby_yPLJXD7cWqxCEm07q4N1/exec", {
        method: "POST",
      ...
      <div className="mt-20 container mx-auto py-12 px-6 text-center">
        ...
        <div className="bg-card p-8 rounded-lg shadow-lg max-w-2xl mx-auto mb-8">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input type="email" placeholder="Your Email" name="email" value={formData.email} onChange={handleChange} className="col-span-1" />
            <Input type="tel" placeholder="Your Phone Number" name="phone" value={formData.phone} onChange={handleChange} className="col-span-1" />
            <Input type="text" placeholder="Subject" name="subject" value={formData.subject} onChange={handleChange} className="col-span-1" />
            <Textarea placeholder="Your Message" name="message" rows={4} value={formData.message} onChange={handleChange} className="col-span-2" />
        ...
        <div className="flex flex-col items-center gap-6 max-w-xl mx-auto">
          <div className="flex items-center gap-4 p-4 bg-card rounded-lg border w-full">
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-sm text-left text-muted-foreground">Grab Gardenn Healthy Foods, Roorkee, Uttarakhand -247667</p>
            </div>
          </div>
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent>
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="text-lg font-medium">+91 9286686912</p>
          </div>
        </DialogContent>
      </Dialog>
    </div>
